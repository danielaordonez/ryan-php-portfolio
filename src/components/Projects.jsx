...
import shoreImg from '../assets/shore.png'
...
const Projects = () => {
  ...
  const projects = [
    {
      title: 'Shero Commerce',
      subtitle: 'Shopify Plus Agency',
      description:
        'Shopify Plus development agency delivering migrations, conversion-focused storefronts, performance, SEO, and integrated marketing for innovative brands—US and European teams supporting merchants at scale.',
      technologies: ['Shopify Plus', 'Liquid', 'Hydrogen', 'React', 'Node.js', 'eCommerce'],
      categories: ['Fullstack'],
      image: shoreImg,
      liveLink: 'https://www.linkedin.com/company/shero-commerce',
      githubHidden: true
    },
    {
      title: 'Highnote',
